...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Anonymous, moderated crypto escrow service supporting Monero and Bitcoin." },
      { name: "author", content: "Fair Trade" },
      { property: "og:title", content: "Fair Trade — anonymous crypto escrow" },
      { property: "og:description", content: "Anonymous, moderated crypto escrow service supporting Monero and Bitcoin." },
